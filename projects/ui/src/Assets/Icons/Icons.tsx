...
export { ReactComponent as CircledX } from "./circled-x.svg";
...
export { ReactComponent as SmallGreenCheck } from "./small-green-check.svg";
export { ReactComponent as SmallRedX } from "./small-red-x.svg";
