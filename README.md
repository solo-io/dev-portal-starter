...
| `VITE_PORTAL_SERVER_URL` | This is the URL for the Gloo Platform Portal REST server. The default value is "/v1". <br> - Note: If using the example `RouteTable` for the "oidcAuthorizationCode" `ExtAuthPolicy` configuration, this should be set to "/portal-server/v1" |
