...
# SESSION_EXPIRED_BEHAVIOR
ifneq ($(VITE_SESSION_EXPIRED_BEHAVIOR),)
	UI_ARGS += VITE_SESSION_EXPIRED_BEHAVIOR=$(VITE_SESSION_EXPIRED_BEHAVIOR)
else ifneq ($(SESSION_EXPIRED_BEHAVIOR),)
	UI_ARGS += VITE_SESSION_EXPIRED_BEHAVIOR=$(SESSION_EXPIRED_BEHAVIOR)
endif
