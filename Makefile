...
#
# REVOKATION_ENDPOINT
ifneq ($(VITE_REVOKATION_ENDPOINT),)
	UI_ARGS += VITE_REVOKATION_ENDPOINT=$(VITE_REVOKATION_ENDPOINT)
else ifneq ($(REVOKATION_ENDPOINT),)
	UI_ARGS += VITE_REVOKATION_ENDPOINT=$(REVOKATION_ENDPOINT)
endif
