...
#
# DEFAULT_APP_AUTH_METHOD
ifneq ($(VITE_DEFAULT_APP_AUTH_METHOD),)
	UI_ARGS += VITE_DEFAULT_APP_AUTH_METHOD=$(VITE_DEFAULT_APP_AUTH_METHOD)
else ifneq ($(DEFAULT_APP_AUTH_METHOD),)
	UI_ARGS += VITE_DEFAULT_APP_AUTH_METHOD=$(DEFAULT_APP_AUTH_METHOD)
endif
